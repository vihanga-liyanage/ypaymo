...
class ProductInsert_ctrl extends CI_Controller
{
    private $data;
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('productInsert_model'));
        $this->data['img_path'] = base_url("assets/images/product/");
        $this->data['result'] = $this->productInsert_model->get_product();
    }

    public function index()
    {
        $this->data['img_path'] = base_url("assets/images/product/");
        $this->load->view('productInsert_view', $this->data);
    }
    ...
    public function insert()
    {
        ...
        $this->form_validation->set_rules('warrantyPeriod','warrantyPeriod', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('productInsert_view');
        } else {
            ...
            else
            {
                ...
                $this->productInsert_model->insert_into_image($data);
                ...
                $params['dateAdded'] = $this->input->post('dateAdded');
                $params['fileName'] = $upload_data['file_name'];



                $this->productInsert_model->insert_into_product($params);
                //$this->index();
                redirect('ProductInsert_ctrl');
